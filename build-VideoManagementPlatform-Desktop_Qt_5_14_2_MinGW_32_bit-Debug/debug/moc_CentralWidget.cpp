...
#include <memory>
#include "../../FinalClient/CentralWidget.h"
...
QT_MOC_LITERAL(1, 14, 12), // "switchSignal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13), // "sigFullScreen"
QT_MOC_LITERAL(4, 42, 9), // "RecvFresh"
QT_MOC_LITERAL(5, 52, 13) // "switchWindows"

    },
    "CentralWidget\0switchSignal\0\0sigFullScreen\0"
    "RecvFresh\0switchWindows"
};
...
void CentralWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->switchSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sigFullScreen(); break;
        case 2: _t->RecvFresh((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->switchWindows((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CentralWidget::switchSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CentralWidget::sigFullScreen)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CentralWidget::switchSignal(int _t1)
{
...
// SIGNAL 1
void CentralWidget::sigFullScreen()
{
