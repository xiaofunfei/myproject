...
#include <memory>
#include "../../FinalClient/LoginWidget.h"
...
QT_MOC_LITERAL(1, 12, 13), // "login_Success"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12), // "login_Button"
QT_MOC_LITERAL(4, 40, 15), // "register_Button"
QT_MOC_LITERAL(5, 56, 12), // "recvUserData"
QT_MOC_LITERAL(6, 69, 20) // "vector<vector<int> >"

    },
    "LoginWidget\0login_Success\0\0login_Button\0"
    "register_Button\0recvUserData\0"
    "vector<vector<int> >"
};
...
void LoginWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->register_Button(); break;
        case 3: _t->recvUserData((*reinterpret_cast< vector<vector<int> >(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginWidget::login_Success)) {
                *result = 0;
                return;
            }
        }
