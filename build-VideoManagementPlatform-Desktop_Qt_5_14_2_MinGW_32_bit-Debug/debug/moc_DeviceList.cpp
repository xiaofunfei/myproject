...
#include <memory>
#include "../../FinalClient/DeviceList.h"
...
QT_MOC_LITERAL(5, 33, 19), // "onItemDoubleClicked"
QT_MOC_LITERAL(6, 53, 16), // "QTreeWidgetItem*"
QT_MOC_LITERAL(7, 70, 4), // "item"
QT_MOC_LITERAL(8, 75, 6) // "column"

    },
    "DeviceList\0sendMessage\0\0time\0msg\0"
...
void DeviceList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DeviceList::*)(const QString & , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DeviceList::sendMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DeviceList::sendMessage(const QString & _t1, const QString & _t2)
{
