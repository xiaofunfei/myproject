...
#include <memory>
#include "../../FinalClient/CameraWidget.h"
...
QT_MOC_LITERAL(1, 13, 14), // "onFrameDecoded"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8), // "cameraId"
QT_MOC_LITERAL(4, 38, 5) // "image"

    },
    "CameraWidget\0onFrameDecoded\0\0cameraId\0"
    "image"
};
...
void CameraWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onFrameDecoded((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QImage(*)>(_a[2]))); break;
        default: ;
        }
    }
}
