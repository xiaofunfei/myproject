...
#include <memory>
#include "../../FinalClient/RegisterDialog.h"
...
QT_MOC_LITERAL(1, 9, 12), // "onHandleRead"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 16), // "on_registerclick"
QT_MOC_LITERAL(4, 40, 15) // "on_sendUsername"

    },
    "Register\0onHandleRead\0\0on_registerclick\0"
    "on_sendUsername"
};
...
void Register::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onHandleRead(); break;
        case 1: _t->on_registerclick(); break;
        case 2: _t->on_sendUsername(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
